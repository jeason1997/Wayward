...
if (process.platform === "darwin") {
	if (process.arch === "x64") {
		fileName = "greenworks-osx64";
	} else if (process.arch === "ia32") {
		fileName = "greenworks-osx32";
	}
} else if (process.platform === "win32") {
	if (process.arch === "x64") {
		fileName = "greenworks-win64";
	} else if (process.arch === "ia32") {
		fileName = "greenworks-win32";
	}
} else if (process.platform === "linux") {
	if (process.arch === "x64") {
		fileName = "greenworks-linux64";
	} else if (process.arch === "ia32") {
		fileName = "greenworks-linux32";
	}
}

greenworks = require(path.join(installDir, fileName));
